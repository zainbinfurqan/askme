...
function Browse(props:any) {
    ...
    const handleSelectComment = (flag: any, item: any) => {
        if(flag === 'comment') {
            setSelectedOption({...selectedOption, comment: {id: item.id, isOpen: !selectedOption.comment.isOpen}})
        }
        if(flag === 'nested') {
            setSelectedOption({...selectedOption, nestedComment: {id: item.id, isOpen: !selectedOption.nestedComment.isOpen}})
        }
    ...
    return (
        <div className=''>
            ...
            <div className='flex flex-col justify-center'>
                ...
                <div className='mx-9 py-2 flex flex-row justify-evenly'>
